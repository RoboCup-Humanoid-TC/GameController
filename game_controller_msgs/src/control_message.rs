...
use crate::bindings::{
    ...
    GAME_PHASE_NORMAL, GAME_PHASE_PENALTYSHOOT, GAME_PHASE_TIMEOUT, GAME_PHASE_OVERTIME, MAX_NUM_PLAYERS, PENALTY_NONE,
    ...
    pub fn new(game: &Game, params: &Params, packet_number: u8, to_monitor: bool) -> Self {
        ...
        Self {
            ...
            game_phase: match (game.phase, game.state) {
                ...
                (Phase::FirstExtraHalf | Phase::SecondExtraHalf, _) => GAME_PHASE_OVERTIME, // not used in spl
